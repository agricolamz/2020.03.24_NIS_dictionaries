...
\begin{figure}[h]
\centering
\fbox{\includegraphics[height=6cm]{images/old_village.jpg}}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        % The same should be done for plural stem formation
    \end{itemize}
\end{itemize}
...
\includegraphics[scale=0.4]{images/pstfull.png} % add image
\end{figure}
...
\begin{frame}{Derived verb inflection}
